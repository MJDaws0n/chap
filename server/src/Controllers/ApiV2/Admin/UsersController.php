...
class UsersController extends BaseApiV2Controller
{
    ...
    public function destroy(string $user_id): void
    {
        ...
        if ((int)($this->user?->id ?? 0) === (int)$user->id) {
            $this->v2Error('failed_precondition', 'Cannot delete your own user', 409);
            return;
        }
        $user->delete();
