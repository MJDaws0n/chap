    ...
    <nav class="sidebar-nav">
        ...
        <?php if (!empty($user['is_admin'])): ?>
            <div class="sidebar-section">
                ...
                <a href="/admin/nodes" class="sidebar-link <?= str_starts_with(($currentPage ?? ''), 'admin-nodes') ? 'active' : '' ?>">
                    <svg class="sidebar-link-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <a href="/admin/templates" class="sidebar-link <?= str_starts_with(($currentPage ?? ''), 'admin-templates') ? 'active' : '' ?>">
                    <svg class="sidebar-link-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 5a1 1 0 011-1h14a1 1 0 011 1v2a1 1 0 01-1 1H5a1 1 0 01-1-1V5zM4 13a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H5a1 1 0 01-1-1v-6zM16 13a1 1 0 011-1h2a1 1 0 011 1v6a1 1 0 01-1 1h-2a1 1 0 01-1-1v-6z"/>
                    </svg>
                    <span>Templates</span>
