<div class="stack" style="gap: 16px;">
    <div class="stack" style="gap: 6px;">
        <h2 class="h1" style="font-size: 22px;">Create Account</h2>
        <div class="text-muted" style="font-size: 13px;">Create your user and personal team.</div>
    </div>

    <form action="/register" method="POST" class="stack" style="gap: 14px;">
