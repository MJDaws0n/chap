...
final class TeamPermissions
{
    ...
    public const UI = [
        ...
        'applications.resources' => ['label' => 'Application resource limits', 'actions' => ['read', 'write']],
        'files' => ['label' => 'File viewer/editor', 'actions' => ['read', 'write']],
        'volumes' => ['label' => 'Volumes', 'actions' => ['read', 'write', 'execute']],
        'volume_files' => ['label' => 'Volume filesystem', 'actions' => ['read', 'write', 'execute']],
        'deployments' => ['label' => 'Deployments', 'actions' => ['read', 'execute']],
        'logs' => ['label' => 'Logs', 'actions' => ['read']],
        'exec' => ['label' => 'Bash execution', 'actions' => ['write']],
